...
var tChoice: String!
var tMotivation: String!

class Consult3VC: UIViewController, UIDocumentMenuDelegate, UIDocumentPickerDelegate, UINavigationControllerDelegate {
...
//        third.setBottomBorder()
    ...
    @objc func swipeaction(swipe: UISwipeGestureRecognizer) {
        ...
        case 2:
            tChoice = firstexp.text
            tMotivation = first.text! + second.text! + third.text!
            performSegue(withIdentifier: "gotofourth", sender: self)
        default:
            break
